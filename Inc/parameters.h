...
#define ERROR_ANGLE 0.010 //erreur en angle(radians) maximale pour considérer l'objectif comme atteint
#define ERROR_POS 3 // erreur en position (mm)  maximale pour considérer l'objectif comme atteint
#define SPD_TO_STOP 10

#define CONE_ALIGNEMENT (M_PI/2.0) 

#define PID_P 0.32 //0.25
#define PID_I 00.0 //130
#define PID_D 0 // 0.5
#define PID_BIAS 130
